...
namespace WebApi_DBUtility
{
    ...
    public abstract class DBHelper
    {
        ...
        /// <returns></returns>
        public static DataSet GetListByPage(string TableName, int Page, int PageSize, string strWhere, string strOrder, out int TotalPage)
        {
            ...
            DataSet ds = RunProcedure("Proc_ShowList", splist, "table");
