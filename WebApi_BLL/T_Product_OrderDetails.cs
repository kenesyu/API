...
namespace WebApi_BLL
{
    ...
    {
        private readonly WebApi_DAL.T_Product_OrderDetails dal = new WebApi_DAL.T_Product_OrderDetails();
        ...
        public bool Delete(int OrderDetailsID)
        {
            ...
            return dal.Delete(OrderDetailsID);
        }
        ...
        public WebApi_Model.T_Product_OrderDetails GetModel(int OrderDetailsID)
        {
            ...
            return dal.GetModel(OrderDetailsID);
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<WebApi_Model.T_Product_OrderDetails> GetModelList(string strWhere)
        {
