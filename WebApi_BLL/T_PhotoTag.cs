...
namespace WebApi_BLL
{
    ...
    public partial class T_PhotoTag
    {
        ...
        public WebApi_Model.T_Photo_Tag GetModel(int PhotoTagID)
        {
            ...
            return dal.GetModel(PhotoTagID);
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<WebApi_Model.T_Photo_Tag> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<WebApi_Model.T_Photo_Tag> DataTableToList(DataTable dt)
        {
            List<WebApi_Model.T_Photo_Tag> modelList = new List<WebApi_Model.T_Photo_Tag>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                WebApi_Model.T_Photo_Tag model;
