...
namespace WebApi_BLL
{
    ...
    {
        private readonly WebApi_DAL.T_Photo_Store dal = new WebApi_DAL.T_Photo_Store();
        ...
        /// 获得数据列表
        /// </summary>
        public List<WebApi_Model.T_Photo_Store> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<WebApi_Model.T_Photo_Store> DataTableToList(DataTable dt)
        {
            List<WebApi_Model.T_Photo_Store> modelList = new List<WebApi_Model.T_Photo_Store>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                WebApi_Model.T_Photo_Store model;
