...
namespace WebApi_DAL
{
    ...
    public partial class T_Forum_Activity
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(WebApi_Model.T_Forum_Activity model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into T_Forum_Activity(");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(WebApi_Model.T_Forum_Activity model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update T_Forum_Activity set ");
        ...
        public bool Delete(int ActivityID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from T_Forum_Activity ");
            strSql.Append(" where ActivityID=@ActivityID");
            SqlParameter[] parameters = {
					new SqlParameter("@ActivityID", SqlDbType.Int,4)
			};
        ...
        /// 得到一个对象实体
        /// </summary>
        public WebApi_Model.T_Forum_Activity GetModel(int ActivityID)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ActivityID,ActiveType,KeyID,CoverPhoto from T_Forum_Activity ");
            strSql.Append(" where ActivityID=@ActivityID");
            SqlParameter[] parameters = {
					new SqlParameter("@ActivityID", SqlDbType.Int,4)
			};
            ...
            WebApi_Model.T_Forum_Activity model = new WebApi_Model.T_Forum_Activity();
        ...
        /// 得到一个对象实体
        /// </summary>
        public WebApi_Model.T_Forum_Activity DataRowToModel(DataRow row)
        {
            WebApi_Model.T_Forum_Activity model = new WebApi_Model.T_Forum_Activity();
            if (row != null)
            {
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM T_Forum_Activity ");
            if (strWhere.Trim() != "")
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) FROM T_Forum_Activity ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from T_Forum_Activity T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "T_Forum_Activity";
