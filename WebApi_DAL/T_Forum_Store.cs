...
namespace WebApi_DAL
{
    ...
    public partial class T_Forum_Store
    {
        ...
        public int Add(WebApi_Model.T_Forum_Store model)
        {
            ...
            strSql.Append("insert into T_Forum_Store(");
            strSql.Append("UID,ForumID)");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update T_Forum_Store set ");
        ...
        public bool Delete(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from T_Forum_Store ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
        ...
        public WebApi_Model.T_Forum_Store GetModel(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,UID,ForumID from T_Forum_Store ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
        ...
        /// 得到一个对象实体
        /// </summary>
        public WebApi_Model.T_Forum_Store DataRowToModel(DataRow row)
        {
            WebApi_Model.T_Forum_Store model = new WebApi_Model.T_Forum_Store();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,UID,ForumID ");
            strSql.Append(" FROM T_Forum_Store ");
            if (strWhere.Trim() != "")
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) FROM T_Forum_Store ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from T_Forum_Store T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "T_Forum_Store";
