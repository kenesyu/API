...
namespace WebApi_DAL
{
    ...
    public partial class T_Forums
    {
        ...
        public int Add(WebApi_Model.T_Forums model)
        {
            ...
            strSql.Append("UID,Title,FromIP,FromDevice,CategoryID,Content,PostTime,Status,CoverPhoto,TuiMao,Flag)");
        ...
        public bool Update(WebApi_Model.T_Forums model)
        {
            ...
            parameters[9].Value = model.TuiMao;
            parameters[10].Value = model.Flag;
            parameters[11].Value = model.ForumID;
        ...
        public WebApi_Model.T_Forums GetModel(int ForumID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ForumID,UID,Title,FromIP,FromDevice,CategoryID,Content,PostTime,Status,CoverPhoto,TuiMao,Flag from T_Forums ");
            strSql.Append(" where ForumID=@ForumID");
            SqlParameter[] parameters = {
					new SqlParameter("@ForumID", SqlDbType.Int,4)
			};
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ForumID,UID,Title,FromIP,FromDevice,CategoryID,Content,PostTime,Status,CoverPhoto,TuiMao,Flag ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" ForumID,UID,Title,FromIP,FromDevice,CategoryID,Content,PostTime,Status,CoverPhoto,TuiMao,Flag ");
            strSql.Append(" FROM T_Forums ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
