...
namespace WebApi_DAL
{
    ...
    public partial class T_Forum_Likes
    {
        ...
        public int Add(WebApi_Model.T_Forum_Likes model)
        {
            ...
            strSql.Append("insert into T_Forum_Likes(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update T_Forum_Likes set ");
        ...
        public bool Delete(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from T_Forum_Likes ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
        ...
        public WebApi_Model.T_Forum_Likes GetModel(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,UID,ForumID from T_Forum_Likes ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
        ...
        /// 得到一个对象实体
        /// </summary>
        public WebApi_Model.T_Forum_Likes DataRowToModel(DataRow row)
        {
            WebApi_Model.T_Forum_Likes model = new WebApi_Model.T_Forum_Likes();
            if (row != null)
            {
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM T_Forum_Likes ");
            if (strWhere.Trim() != "")
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) FROM T_Forum_Likes ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from T_Forum_Likes T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "T_Forum_Likes";
